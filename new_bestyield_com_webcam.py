...
class PageOne(tk.Frame):
    def __init__(self, master):
        ...
        startbtn = tk.Button(self, text="開始", command=lambda: [camerashow_thread(),cameraSeclectE.grid_forget(),cameraSeclectL.grid_forget(), startbtn.grid_forget()], cursor="hand2",
                             bg="black", fg="white",
                             font="Helvetic 20 bold")
        startbtn.grid(row=12, column=6)
        cameraSeclectL = tk.Label(self, text="Camera Select",font="Helvetic 20 bold",bg='red')
        cameraSeclectL.grid(row=11,column=7)
