...
class SampleApp(tk.Tk):
    def __init__(self):
        ...
        self.iconbitmap('C:\\Users\\GOD\\Pictures\\bestyield1.ico')
...
class StartPage(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.sseGif = tk.PhotoImage(file="C:\\Users\\GOD\\Pictures\\bestyield.gif")
...
class PageOne(tk.Frame):
    def __init__(self, master):
            ...
            if tr == "" or seen == set() or T == "上傳成功" or T == "" or T == "上傳失敗":
                ...
                if duplicated != set():
                    ...
                    if os.path.isdir(path1 + time.strftime('%Y%m%d') + "\\" + tr):  # 如果沒有,新增今天的目錄
                        ...
                        os.makedirs(path1 + time.strftime('%Y%m%d') + "\\" + tr)
                    global path
                    path = path1 + time.strftime('%Y%m%d') + "\\"  # 定義成今天的資料夾
                    global person_list
                    person_list = os.listdir(path + tr)
                    person_list.sort()
                    print(person_list)
                    ...
                    if person_cnt < 10:
                        ...
                        current_pic_dir = path + tr + "\\" + tr + "_" + str(person_cnt)
                    img = cv2.imread("C:\\Users\\GOD\\Pictures\\test3.png")
                    cv2.imwrite(current_pic_dir + ".png", img)  # 寫到今天/ s/n /的資料夾裡

                    my_files = {'file': open("%s.png" % current_pic_dir, 'rb')}

                    img = tk.PhotoImage(file="C:\\Users\\GOD\\Pictures\\test3.png")
        ...
        def takepic():
            ...
            global data1
            ret, frame = cap.read()
            cv2.imwrite("C:\\Users\\GOD\\Pictures\\test3.png", frame)
            img = tk.PhotoImage(file="C:\\Users\\GOD\\Pictures\\test3.png")
        ...
        self.sseGif = tk.PhotoImage(file="C:\\Users\\GOD\\Pictures\\20.png")
